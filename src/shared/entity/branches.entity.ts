...
export class Branches extends BaseEntity {
    ...
    @Column('varchar', { name: 'tel_num', length: 50, nullable: true })
    telNum: string | null;

    @Column('varchar', { name: 'mob_num', length: 50, nullable: true })
    mobNum: string | null;

    @Column('varchar', { name: 'free_line', length: 255, nullable: true })
